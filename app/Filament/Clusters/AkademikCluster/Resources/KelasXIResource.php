...
use App\Filament\Clusters\AkademikCluster\Resources\KelasXIResource\Pages;
use App\Filament\Clusters\AkademikCluster\Resources\KelasXIResource\RelationManagers;
...
{
    protected static ?string $model = KelasXI::class;
    ...
    public static function table(Table $table): Table
{
    ...
    ->query(
            static::getModel()::query()
                ->whereHas('student', function ($query) {
                    $query->where('kelas', 'XI'); // ⬅️ FILTER KELAS XI
                })
        )
        ->columns([
    ...
    {
        return [
            'index' => Pages\ListKelasXI::route('/'),
            'create' => Pages\CreateKelasXI::route('/create'),
            'edit' => Pages\EditKelasXI::route('/{record}/edit'),
        ];
    }
}
